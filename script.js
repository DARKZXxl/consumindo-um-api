...
function mostrarNaTela(data) {
    ...
    const gender = criarTrComImg(data.gender ,'gender', 'https://img.icons8.com/color/48/male.png',  'https://img.icons8.com/color/48/female.png')
    ...
    table.append(species, gender, house, wizard, actor, ancestry, patronus, dateOfBirth)
